...
<table class="formtable">
	...
	<tr>
		<td class="key">
			<label for="filepermission-member" class="label">*<?php echo JText::_('COM_COMMUNITY_FILES_ALLOW_MEMBERS')?> </label>
		</td>
		<td class="value" style="vertical-align: middle">
			<input type="checkbox" value="1" name="filepermission-member" <?php echo ($params->get('filepermission-member') > 0) ? 'checked="checked"' : '' ?>/>
		</td>
	</tr>
	<?php }?>
	...
	<tr>
		...
		<td class="value">
			...
			<input type="submit" class="button btn" value="<?php echo JText::_('COM_COMMUNITY_SAVE');?>" onclick="saveContent();" />
			<input type="button btn" name="cancel" value="<?php echo JText::_('COM_COMMUNITY_CANCEL_BUTTON'); ?>" onclick="javascript:history.go(-1);return false;" class="button btn" />
