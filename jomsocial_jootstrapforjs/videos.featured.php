...
?>
		...
		<!-- Slider Kit styles -->
		<!-- <link rel="stylesheet" type="text/css" href="<?php //echo JURI::root(); ?>components/com_community/assets/featuredslider/sliderkit-core.css" media="screen, projection" /> -->
		<!-- <link rel="stylesheet" type="text/css" href="<?php //echo JURI::root(); ?>components/com_community/assets/featuredslider/sliderkit.css" media="screen, projection" /> -->
