...
?>
	...
	<div class="mini-profile" id="member_<?php echo $member->id;?>">
		...
		<div class="jsAbs jsFriendRespond">
		    ...
		    <input type="submit" class="button btn" style="margin:0" onclick="joms.groups.confirmMemberRemoval(<?php echo $member->id; ?>, <?php echo $groupid;?>);" value="<?php echo JText::_('COM_COMMUNITY_GROUPS_REMOVE_MEMBER_MESSAGE');?>" />
			<?php endif; ?>
		</div>
