...
<div id="friend-<?php echo $user->id; ?>" class="mini-profile jsFriendList">
	...
	<div class="jsAbs jsFriendRespond">
    	<input type="submit" class="button btn" style="margin:0" onclick="joms.friends.confirmFriendRemoval(<?php echo $user->id; ?>);" value="<?php echo JText::_('COM_COMMUNITY_REMOVE_FRIEND'); ?>" />
	</div>
	<?php endif; ?>
