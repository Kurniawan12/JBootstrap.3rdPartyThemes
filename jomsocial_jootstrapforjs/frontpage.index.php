...
<div id="cFrontpageWrapper">
    ...
    <!-- begin: .cLayout -->
    <div class="cLayout clrfix row-fluid">
        <!-- begin: .cMain -->
        <div class="cMain clrfix span9">				
            <?php
            /**
             * ----------------------------------------------------------------------------------------------------------			
        ...
        <!-- begin: .cSidebar -->
        <div class="cSidebar clrfix span3">
            ...
            <?php if ($this->params->get('showsearch') == '1' || ($this->params->get('showsearch') == '2' && $my->id != 0 )) { ?>
                ...
                <?php if ($this->params->get('showsearch')) { ?>
                    <div class="cModule searchbox">
                        ...
                        <form name="search" id="cFormSearch" method="get" action="<?php echo CRoute::_('index.php?option=com_community&view=search'); ?>" class="form-search">
