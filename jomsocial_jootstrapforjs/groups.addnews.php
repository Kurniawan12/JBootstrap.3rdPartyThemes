...
<table class="formtable">
	...
	<tr>
		...
		<td class="value" style="vertical-align: middle">
			<input type="checkbox" name="filepermission-member" value="1" />
		</td>
	</tr>
	<?php }?>
	<?php endif; ?>
	...
	<tr>
		<td class="key"></td>
		<td class="value">
			<input type="submit" name="submit" value="<?php echo JText::_('COM_COMMUNITY_GROUPS_BULLETIN_ADD'); ?>" class="button btn" onclick="saveContent();" />
