...
?>
<div class="greybox row-fluid">

    <!-- Start the Intro text -->
    <div class="cFrontPageLeft span9">
        <div class="introduction">
            <h1><?php echo JText::_('COM_COMMUNITY_GET_CONNECTED_TITLE'); ?></h1>
            <ul id="jbfeaturelist">
                <li ><i class="icon-star"></i> <?php echo JText::_('COM_COMMUNITY_CONNECT_AND_EXPAND'); ?></li>
                <li ><i class="icon-star"></i> <?php echo JText::_('COM_COMMUNITY_VIEW_PROFILES_AND_ADD_FRIEND'); ?></li>
                <li ><i class="icon-star"></i> <?php echo JText::_('COM_COMMUNITY_SHARE_PHOTOS_AND_VIDEOS'); ?></li>
                <li ><i class="icon-star"></i> <?php echo JText::_('COM_COMMUNITY_GROUPS_INVOLVE'); ?></li>
            </ul>
            <?php if ($usersConfig->get('allowUserRegistration')) : ?>
                <div class="joinbutton">
                    <a id="jbjoinButton" class="btn btn-primary" href="<?php echo CRoute::_('index.php?option=com_community&view=register', false); ?>" title="<?php echo JText::_('COM_COMMUNITY_JOIN_US_NOW'); ?>">
    ...
    <div class="cFrontPageRight span3">
        <div class="loginform">
            <form action="<?php echo CRoute::getURI(); ?>" method="post" name="login" id="form-login" >
                ...
                <div style="text-align: center; padding: 10px 0 5px;">
                    <input type="submit" value="<?php echo JText::_('COM_COMMUNITY_LOGIN_BUTTON'); ?>" name="submit" id="submit" class="button btn" />
