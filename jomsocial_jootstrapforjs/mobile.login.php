...
<div class="buttons-area">
	<input type="submit" value="<?php echo JText::_('COM_COMMUNITY_IPHONE_BUTTON_LOGIN');?>" name="submit" id="submit" class="button btn" />
	<input type="button btn" value="<?php echo JText::_('COM_COMMUNITY_IPHONE_BUTTON_CLEAR');?>" name="clear" id="clear" class="button btn" onclick="clearInputs();return false;" />
