...
?>
	...
	?>
		<div>
			...
			<input class="button btn" id="btnCancel" type="button btn" value="<?php echo JText::_('COM_COMMUNITY_CANCEL_BUTTON');?>" onclick="uploader.cancelQueue();" disabled="disabled" style="margin-left: 2px; font-size: 8pt; height: 29px;" />
		</div>
		<div class="clr"></div>
