...
<div class="cProfile-PrefNav">
	<ul>
	<li><a href="#generalPref">General</a></li>
	<li><a href="#privacyPref">Privacy Setting</a></li>
	<li><a href="#emailPref">Email and Notifications</a></li>
	<li><a href="#blocklistPref">Blocked List</a></li>
	</ul>
	<div class="saveButton" ><input type="submit" class="button btn" value="<?php echo JText::_('COM_COMMUNITY_SAVE_BUTTON'); ?>" /></div>
</div>
