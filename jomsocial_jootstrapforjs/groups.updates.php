...
<div id="cGroupsUpdate">
	<div class="cLayout">
	    ...
	    <div class="cSidebar">
		    ...
		    <?php
		    $groupupdate = $this->view('groups')->modGetUserAnnouncement($userid);
		    ...
		    <?php } else { ?>
		    <div class="empty-message"><?php echo JText::sprintf( 'COM_COMMUNITY_GROUPS_UPDATE_DEFAULT' , CRoute::_('index.php?option=com_community&view=groups') ); ?></div>
		    <?php } ?>
...
<?php } else { ?>
<div class="empty-message"><?php echo JText::sprintf( 'COM_COMMUNITY_GROUPS_UPDATE_NOT_LOGGED_IN' , CRoute::_( 'index.php?option=com_community&view=frontpage' ), CRoute::_( 'index.php?option=com_community&view=register' )) ?></div>
<?php } ?>
