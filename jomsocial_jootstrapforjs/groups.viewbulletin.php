...
<div id="group-buletin-topic" style="float:left;width:76%">
	<!--Buletin : Avatar-->
    ...
    <div class="buletin-detail">
        ...
        <div id="bulletin-edit-data" style="display: none;">
            ...
            <div style="padding-top: 20px">
               <label for="filepermission-member" class="label" style="float:left">*<?php echo JText::_('COM_COMMUNITY_FILES_ALLOW_MEMBERS')?></label>
			   <input type="checkbox" style="margin-left: 10px" name="filepermission-member" value="1" <?php echo ($params->get('filepermission-member') > 0) ? 'checked="checked"' : '' ?> />
            </div>
            <?php }?>
            ...
            <div style="text-align: center; padding-top: 20px;">
                ...
                <input type="submit" value="<?php echo JText::_('COM_COMMUNITY_SAVE_BUTTON'); ?>" class="button btn" onclick="saveContent();" />
                <input type="button btn" class="button btn" onclick="joms.groups.editBulletin();return false;" value="<?php echo JText::_('COM_COMMUNITY_CANCEL_BUTTON'); ?>" />
            </div>
            </form>
        </div>
        <!--Buletin : Edit Entry-->
