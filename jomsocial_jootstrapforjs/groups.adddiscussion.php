...
<table class="formtable">
	...
	<tr>
		<td class="key">
			<label for="title" class="label">*<?php echo JText::_('COM_COMMUNITY_FILES_ALLOW_MEMBERS')?> </label>
		</td>
		<td class="value" style="vertical-align: middle">
			<input type="checkbox" value="1" name="filepermission-member"/>
		</td>
	</tr>
	<?php }?>
	<?php endif; ?>
	...
	<tr>
		...
		<td class="value">
			...
			<input type="submit" class="button btn" value="<?php echo JText::_('COM_COMMUNITY_GROUPS_ADD_DISCUSSION_BUTTON');?>" onclick="saveContent();" />
