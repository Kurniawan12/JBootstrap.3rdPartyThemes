...
<div class="cProfile-ProfileNav">
	...
	<div class="saveButton" ><input type="submit" name="frmSubmit" onclick="submitbutton(); return false;" class="button btn" value="<?php echo JText::_('COM_COMMUNITY_SAVE_BUTTON'); ?>" /></div>
</div>
