...
<div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
	...
	<div id="tabs-1">
		...
		<div style="diplay:block;margin:0 0 10px 20px;">
			...
			<!--input class="video-action button" type="button btn" onclick="joms.videos.linkVideo('<?php echo $creatorType; ?>', '<?php echo $groupid; ?>');" value="<?php echo JText::_('COM_COMMUNITY_NEXT'); ?>"/-->
			<br/>
			<?php echo '<button class="button btn" onclick="joms.videos.submitLinkVideo();">' . JText::_('COM_COMMUNITY_VIDEOS_LINK') . '</button>'; ?>
		</div>
	</div>
	<?php
	if( $enableVideoUpload )
	...
	<div id="tabs-2">
			  ...
			  <?php echo '<button class="button btn" onclick="joms.videos.submitUploadVideo();">' . JText::_('COM_COMMUNITY_VIDEOS_UPLOAD') . '</button>'; ?>
		  </div>
