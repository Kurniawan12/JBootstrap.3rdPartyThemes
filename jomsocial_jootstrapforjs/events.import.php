...
<div class="jsiCalOption">
	<ul class="cResetList">
		...
		<li>
			<input type="submit" value="<?php echo JText::_('COM_COMMUNITY_EVENTS_IMPORT');?>" class="button btn" />
...
<form action="<?php echo $saveimportlink;?>" method="post">
			...
			<div class="jsiCalDetail">
				...
				<div class="clrfix">
					...
					<div class="jsiCalData small">
						...
						<select name="event-<?php echo $i;?>-repeat" id="event-<?php echo $i;?>-repeat">
				...
				<div class="clrfix">
					...
					<div class="jsiCalData small">
						<input type="text" name="event-<?php echo $i;?>-limit" id="event-<?php echo $i;?>-limit" value="<?php echo $event->getRepeatLimit();?>" size="10" maxlength="5"/>
					</div>
				</div>
	...
	<div style="text-align: center;margin-top: 10px;"><input type="submit" value="<?php echo JText::_('COM_COMMUNITY_EVENTS_IMPORT');?>" class="button btn" /></div>
</form>
<?php } ?>