...
<div id="pending-<?php echo $row->connection_id; ?>" class="mini-profile jsFriendPending">
    ...
    <div class="jsAbs jsFriendRespond">
    	<input type="submit" class="button btn" style="margin:0" onclick="jax.call('community' , 'friends,ajaxApproveRequest' , '<?php echo $row->connection_id; ?>');" value="<?php echo JText::_('COM_COMMUNITY_PENDING_ACTION_APPROVE'); ?>" />
